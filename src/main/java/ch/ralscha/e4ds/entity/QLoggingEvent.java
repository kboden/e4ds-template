...
public class QLoggingEvent extends EntityPathBase<LoggingEvent> {
    ...
    public final SetPath<LoggingEventException, QLoggingEventException> loggingEventException = this.<LoggingEventException, QLoggingEventException>createSet("loggingEventException", LoggingEventException.class, QLoggingEventException.class);

    public final SetPath<LoggingEventProperty, QLoggingEventProperty> loggingEventProperty = this.<LoggingEventProperty, QLoggingEventProperty>createSet("loggingEventProperty", LoggingEventProperty.class, QLoggingEventProperty.class);
    ...
    public QLoggingEvent(BeanPath<? extends LoggingEvent> entity) {
